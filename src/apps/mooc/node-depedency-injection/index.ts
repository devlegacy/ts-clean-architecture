...
import {
  MongoConfigFactory, RabbitMQConfigFactory,
} from '#@/src/Contexts/Mooc/Shared/infrastructure/index.js'
import {
  InMemoryCommandBus,
} from '#@/src/Contexts/Shared/infrastructure/CommandBus/index.js'
import {
...
import {
  InMemoryQueryBus,
} from '#@/src/Contexts/Shared/infrastructure/QueryBus/index.js'
