...
const firstItem = new CartItem(new ItemId('d926938c-40f7-485a-ba7a-c0255d2fcb90'), new Money(10, 'usd'))
const secondItem = new CartItem(new ItemId('fb74a5f1-a6eb-4fcc-b4ed-ba4c16073893'), new Money(11, 'usd'))
const thirdItem = new CartItem(new ItemId('d804ea03-50c2-4c1f-a5de-ab43d3f63a91'), new Money(12, 'usd'))
